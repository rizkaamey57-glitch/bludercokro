  ...
  const timelineData = [
    {
      ...
      desc: "Warisan resep legendaris Bluder Cokro mulai tercipta di Madiun, menjaga keotentikan rasa yang lembut dan khas secara turun-temurun."
    },
    {
      year: "2016",
      ...
      desc: "Cokro Group membangun pabrik baru dengan standar food safety guna mencapai target produksi yang lebih besar."
    },
    {
      year: "2018",
      ...
      desc: "Melakukan pembaruan signifikan pada logo dan kemasan produk untuk menembus pasar yang lebih modern."
    },
    {
      year: "2020",
      ...
      desc: "Kelembutan Bluder Cokro hadir untuk merajut rasa di Nusantara, hingga ke rumah Anda."
    }
  ];
    ...
    <div className="bg-brand-cream min-h-screen">
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="/foto/background (2).jpeg" alt="Bluder Cokro Bakery" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-20">
          <motion.div initial="hidden" animate="visible" variants={fadeUpVariant} className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-playfair font-bold text-brand-cream mb-6 leading-tight">
              Legenda Rasa dari <br className="hidden md:block" />
                ...
                >
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="text-left flex flex-col items-start">
                      <div className="inline-block px-6 py-2.5 rounded-full bg-brand-red/10 text-brand-red text-lg font-bold -mt-12 mb-4">
                      ...
                      <motion.p 
                        ...
                        className="text-brand-brown/80 text-xl leading-relaxed italic"
                      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-playfair font-bold text-brand-brown mb-6">
                Standar Mutu <br />
                <span className="text-brand-red italic">Tanpa Kompromi</span>
              </h2>

              <p className="text-brand-brown/80 text-lg mb-10 leading-relaxed">
...
<div className="fixed bottom-6 right-6 z-50">
  ...
  <button
    ...
    className="bg-brand-red hover:bg-brand-brown text-white px-5 py-3 rounded-full shadow-xl flex items-center gap-2 transition-all duration-300 hover:scale-105"
  >
  ...
  <AnimatePresence>
    {faqOpen && (
      <motion.div
        ...
        className="absolute bottom-16 right-0 w-[320px] bg-white rounded-3xl shadow-2xl border border-brand-brown/10 overflow-hidden"
      >
        
        {/* Header */}
        <div className="p-5 border-b border-brand-brown/10">
          ...
          {[
            {
              ...
              answer:
                "Bluder Cokro dapat bertahan sekitar 3–5 hari dalam suhu ruang."
            },
            {
              question: "Apakah tersedia hampers?",
              answer:
                "Ya, tersedia hampers eksklusif untuk hadiah dan acara spesial."
            },
            {
              question: "Bagaimana cara memesan?",
              answer:
                "Pemesanan dapat dilakukan melalui website maupun WhatsApp."
            }
          ].map((faq, index) => (
            <div
              key={index}
              className="border-b border-brand-brown/5 last:border-none"
            >
              <button
                onClick={() =>
              ...
              >
                <span className="text-sm font-medium text-brand-brown pr-3">
                  {faq.question}
                </span>
              ...
              <AnimatePresence>
                {faqActive === index && (
                  ...
                  >
                    <div className="px-5 pb-4 text-sm text-brand-brown/70 leading-relaxed">
                      {faq.answer}
                    </div>
                  </motion.div>
                )}
